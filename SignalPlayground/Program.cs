...
var lowpass = Filters.LowPass(0.9f).Apply;
var lowpassSmaller = Filters.LowPass(0.5f).Apply;
var highpass = Filters.HighPass(0.9f).Apply;
var addNoise = Filters.AddNormalNoise(0,0.2f).Apply;
var cutOutlier = new CutOutliersFilter(0.05f,0.95f).Apply;
var normalization = new ZScoreNormalization(0,1).Apply;
